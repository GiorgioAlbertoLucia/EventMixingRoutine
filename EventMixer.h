...
class EventMixer
{
    public: 
        ...
        void SaveMixedTree(TFile * outputFile);
    ...
    protected:
        ...
        {
            return TreeDict::GetColumnValue(row, key, m_columnTypeCache);
        }
...
void EventMixer::SaveMixedTree(TFile * outputFile)
{
    ROOT::EnableImplicitMT(m_nThreads);

    std::string treeName = "MixedBin";
    outputFile->cd();
    TTree * outputTree = new TTree(treeName.c_str(), treeName.c_str());
