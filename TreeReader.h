...
namespace TreeDict{
    ...
    */
    void CacheColumnTypes(Row& row, std::map<std::string, size_t>& columnTypeCache)
    {
    ...
    */
    ColumnValue GetColumnValue(Row& row, const std::string& key, std::map<std::string, size_t>& columnTypeCache ) {
    ...
    */
     ...
     * 
    */
    void InitRowFromDict(std::vector<std::string>& dictionary, Row& row) {
    ...
    */
    void SetBranchAddressesFromDict(TTree* tree, std::vector<std::string>& dictionary, Row& row) {
        for (const auto& line : dictionary) {
            std::stringstream ss(line);
            std::string key, value;
            char delim = '/';
    ...
    */
    void CreateBranchesFromDict(TTree* tree, std::vector<std::string>& dictionary, Row& row) {
        for (const auto& line : dictionary) {
            std::stringstream ss(line);
            std::string key, value;
            char delim = '/';
